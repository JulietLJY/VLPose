...
def merge_args(cfg, args):
    ...
    # ----------------------- ann files -----------------------
    if args.test_ann_file:
        cfg.val_dataloader['dataset']['ann_file'] = cfg.test_dataloader['dataset']['ann_file'] = args.test_ann_file
        cfg.val_evaluator['ann_file'] = cfg.test_evaluator['ann_file'] =  'data/' + args.test_ann_file
    if args.test_bbox_file:
        if args.test_bbox_file == 'none':
            del cfg.val_dataloader['dataset']['bbox_file']
            del cfg.test_dataloader['dataset']['bbox_file']
        else:
            cfg.val_dataloader['dataset']['bbox_file'] = cfg.test_dataloader['dataset']['bbox_file'] = 'data/' + args.test_bbox_file
